...
/**
 * Check the undefined variables and fix it.
 * 
 * @param {Function} fn
 * @param {Object|Function} options or callback
 */

function fixUndef (fn, options) {
  try {
    fn.call(options.scope, options);
  }
  catch (e) {
    if (e.message.indexOf('is not defined')) {
      var vars = e.message.replace('is not defined', '').trim();
      options[vars] = {toString:function () {return undefined}};
      fixUndef(fn, options);
    }
  }
}
